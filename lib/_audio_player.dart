		...
		channel.setMethodCallHandler((MethodCall call) {
			...
			switch (call.method) {
				...
				case "onBufferingUpdate":
					...
					break;
				case "onAudioReady":
					print('onAudioReady, audioLength: ${call.arguments['audioLength']}');
				...
				case "onPlayerPlaybackUpdate":
					print('onPlayerPlaybackUpdate, position: ${call.arguments['position']}');
